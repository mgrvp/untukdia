...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hay kamu...", "Ada pertanyaan yang perlu dijawab", "question").then(function () {
    Swal.fire("Tolong jawab secara jujur").then(function () {
      Swal.fire("Jawab dengan jujur dan spontan", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `Hay ${nama}, Apakah kamu menyayangi ${sender}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
                  ...
                  Swal.fire(`Terimakasih sudah menyayangi ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        Swal.fire('Apakah anda yakin tidak merindukannya?', '', 'error').then(function () {
                          Swal.fire('Baiklah, Terimakasih')
                        })
                      }
                    })
                  })
              ...
              Swal.fire(`Apakah anda yakin tidak menyayangi ${sender}?`, '', 'error').then(function () {
                Swal.fire('Baiklah, Terimakasih')
              })
            }
          })
